...
interface RandomFunction extends PRNG {
	/**
	* Returns an ndarray containing pseudorandom numbers drawn from a triangular distribution.
	*
	...
	*/
	<T extends typedndarray<number>, U extends typedndarray<number>, V extends typedndarray<number>>( shape: Shape, a: number | T, b: number | U, c: number | V, options?: Options ): RandomArray;

	/**
	* Fills an ndarray with pseudorandom numbers drawn from a triangular distribution.
	*
	* @param a - minimum support
	* @param b - maximum support
	* @param c - mode
	...
	* @returns output ndarray
	*/
	assign<T extends typedndarray<number>, U extends typedndarray<number>, V extends typedndarray<number>, W extends typedndarray<number>>( a: number | T, b: number | U, c: number | V, out: W ): W;
}
...
interface Random extends PRNG {
	...
	*
	* @example
	* var out = triangular( [ 3, 3 ], 2.0, 5.0, 3.0 );
	* // returns <ndarray>
	*/
	<T extends typedndarray<number>, U extends typedndarray<number>, V extends typedndarray<number>>( shape: Shape, a: number | T, b: number | U, c: number | V, options?: Options ): RandomArray;
	...
	*/
	...
	/**
	* Returns a function for creating ndarrays containing pseudorandom numbers drawn from a triangular distribution.
	*
	* @param options - function options
