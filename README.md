...
> Generate pseudorandom numbers drawn from a [triangular][@stdlib/random/base/triangular] distribution.
...
```javascript
triangular = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-triangular@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/random-triangular/tags). For example,

```javascript
triangular = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-triangular@v0.1.1-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var triangular = require( 'path/to/vendor/umd/random-triangular/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/random-triangular@umd/browser.js"></script>
```
...
Returns an [ndarray][@stdlib/ndarray/ctor] containing pseudorandom numbers drawn from a [triangular][@stdlib/random/base/triangular] distribution.

```javascript
var arr = triangular( [ 3, 3 ], 2.0, 5.0, 3.0 );
// returns <ndarray>
```
...
-   **c**: mode. May be either a scalar or an [ndarray][@stdlib/ndarray/ctor]. When providing an [ndarray][@stdlib/ndarray/ctor], the [ndarray][@stdlib/ndarray/ctor] must be [broadcast compatible][@stdlib/ndarray/base/broadcast-shapes] with the specified output shape.
...
var arr = triangular( [ 2, 3, 3 ], a, b, c );
// returns <ndarray>
```
...
var arr = triangular( [], 2.0, 5.0, 3.0 );
// returns <ndarray>
...
var arr = triangular( [ 3, 3 ], 2.0, 5.0, 3.0, opts );
// returns <ndarray>
...
Fills an [ndarray][@stdlib/ndarray/ctor] with pseudorandom numbers drawn from a [triangular][@stdlib/random/base/triangular] distribution.
...
var v = triangular.assign( 2.0, 5.0, 3.0, out );
// returns <ndarray>
...
-   **c**: mode. May be either a scalar or an [ndarray][@stdlib/ndarray/ctor]. When providing an [ndarray][@stdlib/ndarray/ctor], the [ndarray][@stdlib/ndarray/ctor] must be [broadcast compatible][@stdlib/ndarray/base/broadcast-shapes] with the output [ndarray][@stdlib/ndarray/ctor].
-   **out**: output [ndarray][@stdlib/ndarray/ctor].

#### triangular.factory( \[options] )

Returns a function for generating pseudorandom numbers drawn from a [triangular][@stdlib/random/base/triangular] distribution.
...
var random = triangular.factory( opts );
...
The function returned by the `factory` method has the same interface and accepts the same options as the `triangular` function above.
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/random-triangular.svg
[npm-url]: https://npmjs.org/package/@stdlib/random-triangular

[test-image]: https://github.com/stdlib-js/random-triangular/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/random-triangular/actions/workflows/test.yml?query=branch:v0.1.1

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/random-triangular/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/random-triangular?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/random-triangular.svg
[dependencies-url]: https://david-dm.org/stdlib-js/random-triangular/main
...
[deno-url]: https://github.com/stdlib-js/random-triangular/tree/deno
[deno-readme]: https://github.com/stdlib-js/random-triangular/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/random-triangular/tree/umd
[umd-readme]: https://github.com/stdlib-js/random-triangular/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/random-triangular/tree/esm
[esm-readme]: https://github.com/stdlib-js/random-triangular/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/random-triangular/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/random-triangular/main/LICENSE
